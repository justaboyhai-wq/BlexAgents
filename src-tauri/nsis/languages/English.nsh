...
LangString alreadyInstalledLong ${LANG_ENGLISH} "BlexAgent $R5 is already installed.$\n$\nYou can choose to reinstall or uninstall."
...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "BlexAgent $R5 is already installed. You are about to install BlexAgent ${VERSION}.$\n$\nYou can proceed with the upgrade directly."
