...
const JSON_EVENTS = new Set([
    ...
    'chat:attachments-fallback', // Sidecar wrote unsupported-modality attachments to <agentDir>/blexagent_files/ and appended @<path> refs to the user text (see PRD prd_0.2.3_image_modality_file_fallback.md)
