...
| **webtorrent-cli** | `npm_config_prefix="${BLEXAGENT_NPM_GLOBAL_PREFIX:-$HOME/.blexagent/npm-global}" npm install -g webtorrent-cli` | Quick torrent download, stream to VLC |
...
# Optional
npm_config_prefix="${BLEXAGENT_NPM_GLOBAL_PREFIX:-$HOME/.blexagent/npm-global}" npm install -g webtorrent-cli
